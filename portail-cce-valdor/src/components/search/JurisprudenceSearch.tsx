...
import { Search as SearchIcon, Gavel, Scale, History, Tune } from '@mui/icons-material';
        ...
        <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3 }}>
            ...
            <Box sx={{ mb: 4, textAlign: 'center' }}>
                ...
                <Typography variant="subtitle1" color="text.secondary">
                    ...
                    La recherche sémantique trouve les concepts liés même sans les mots exacts.
                </Typography>
            </Box>
