    ...
    return (
        <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column', bgcolor: '#020617', position: 'relative', overflow: 'hidden', '&:hover .header-controls': { opacity: 1 } }}>
            ...
            >
                ...
                <Box sx={{ position: 'relative', zIndex: 10, width: '100%', flex: 1, p: 2, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
                    {activeAttachment.type === 'image' ? (
                        <Box sx={{ flex: 1, width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'auto', minHeight: 0 }}>
                            <img
